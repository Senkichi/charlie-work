...
- [FAIL] `counterexamples_clean` — INCONCLUSIVE (treated as FAIL): only 3/13 counterexample module(s) actually produced an AP (queried) — below the 50% coverage floor required for zero false positives to count as a validated pass; positive control: 3/13 counterexample module(s) actually produced an AP (queried), 10 emitted no AP in any sample (untested by this gate): event_kinds.py, fleet_paths.py, git_pull_blockers.py, logging_setup.py, markdown_fence.py, prompt_sections.py, rescue.py, safe_path.py, safe_ref.py, throttle_signatures.py
...
- `197a85b49a812715a4a872551d0fec538bd1e9ea` (2026-08, 2026-08-01): 442 points, 21 saturated, 0 parse failures
- `1ead8585f58f832c5442dc3d7173a662348e150a` (anchor, 2026-08-16): 589 points, 51 saturated, 0 parse failures
- `7373d47b2d0cf4612dd5600de9f66c320000ac1f` (anchor, 2026-08-17): 628 points, 39 saturated, 0 parse failures
- `9de0b9fc14279ef3578424bfb8fa6687d6eb12a9` (anchor, 2026-08-23): 697 points, 43 saturated, 0 parse failures
