...
def launch_claude_worker(
    ...
    *,
    ...
    # leaks from the orchestrator and to drop GH_TOKEN/GITHUB_TOKEN so workers do
    # not inherit the orchestrator's admin-scoped token (issue #502). To give
    # workers a scoped GitHub token, set claude_code.worker_env={"GH_TOKEN": "<scoped-PAT>"}.
    worker_env = {
