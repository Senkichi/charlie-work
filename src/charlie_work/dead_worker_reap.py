...
Issue #1494 adds one NEW member outside the #1317 extraction set:
``_reap_superseded_workers`` -- the launch-trigger kill of a rework issue's
still-running prior worker. It belongs to this family (worker-process reap
before redispatch) even though it did not exist in workflow.py to move.
