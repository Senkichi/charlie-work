...
worktree cwd, env merging and caps, sidecar writes, error-record paths
(missing binary, worktree-creation failure, foreign-writer, fetch
failure), the rework flag, launch retry, process start-time capture, and
the venv_source / worker_env / materialize_dirs / start_new_session
parity surface with claude-code.
"""
